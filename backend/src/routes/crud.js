...
//
//  :tabla solo puede ser una de las 4 ya migradas: clientes,
//  productos, empleados, polizas. Cualquier otro valor se rechaza
//  explícitamente (evita que alguien intente escribir en otra
//  tabla del esquema, como empresas o auditoria_log, vía esta ruta).
// ============================================================
import { Router } from 'express';
import { verifyAuth } from '../supabaseAuth.js';
import { tablaValida, crear, actualizar, eliminar } from '../supabaseCrud.js';
